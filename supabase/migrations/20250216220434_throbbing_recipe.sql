...
DROP TRIGGER IF EXISTS set_user_number_trigger ON user_profiles;
DROP FUNCTION IF EXISTS set_user_number();
DROP FUNCTION IF EXISTS generate_user_number();
...
-- Create function to set user number
...
-- Create view with all columns including user_number
